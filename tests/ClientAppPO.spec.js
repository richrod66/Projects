...
customtest(' @login Second Login Test', async ({page,testDataForOrder}) =>
{
    ...
    const poManager = new POManager(page); // Initialize the POManager with the current page context
        ...
        const confirmationPage = poManager.getConfirmationPage(); // Get the ConfirmationPage object from POManager
